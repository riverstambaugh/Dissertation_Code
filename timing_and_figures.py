...
def generate_isomorphism_grid(pres_dict):
    ...
    plt.savefig('OneRelationWord_Size1-3_3alph_Isomorphism_sorted_final.png', bbox_inches='tight', pad_inches=0, dpi=1000)
...
def generate_time_grid(pres_dict):
    ...
    plt.savefig('OneWordLength3_3alph_timing.png', bbox_inches='tight', pad_inches=0, dpi=1000)
